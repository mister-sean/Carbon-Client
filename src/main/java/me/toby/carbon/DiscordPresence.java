...
import me.toby.carbon.features.modules.misc.RPC;
...
public class DiscordPresence
{
    ...
    public static void start() {
        ...
        DiscordPresence.presence.largeImageKey = "Carbon Client";
        DiscordPresence.presence.largeImageText = "Carbon Client 1.2.1";
