...
public class AutoCrystal extends Module
{
    ...
    public AutoCrystal() {
        ...
        this.attackFactor = (Setting<Integer>)this.register(new Setting("PredictDelay", 0, 0, 250));
        ...
        this.placeDelay = (Setting<Float>)this.register(new Setting("PlaceDelay", 4.0f, 0.0f, 500.0f));
        ...
        this.breakDelay = (Setting<Float>)this.register(new Setting("BreakDelay", 4.0f, 0.0f, 500.0f));
        ...
        this.opPlace = (Setting<Boolean>)this.register(new Setting("1.13 Place", false));
        ...
        this.targetRange = (Setting<Float>)this.register(new Setting("TargetRange", 4.0f, 1.0f, 15.0f));
        ...
        this.breakMaxSelfDamage = (Setting<Float>)this.register(new Setting("BreakMaxSelf", 4.0f, 0.1f, 36.0f));
        this.breakMinDmg = (Setting<Float>)this.register(new Setting("BreakMinDmg", 4.0f, 0.1f, 12.0f));
        this.minArmor = (Setting<Float>)this.register(new Setting("MinArmor", 4.0f, 0.1f, 90.0f));
        ...
        this.cGreen = (Setting<Integer>)this.register(new Setting("OL-Green", 255, 0, 255, v -> this.outline.getValue()));
