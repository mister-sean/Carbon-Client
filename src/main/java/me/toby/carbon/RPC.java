...
public class RPC {
    ...
    private static String clientVersion = carbon.MODVER;
    ...
    public static void startRPC() {
        ...
        discordRichPresence.largeImageText = "fucking toby";
        discordRichPresence.smallImageKey = "small";
        discordRichPresence.smallImageText = "discord.gg/MdcDNcBpDD";
